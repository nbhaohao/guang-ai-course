import { StoryDocument } from './StoryDocument.mjs';
...
export const storyDocuments = [
    ...
    new StoryDocument({
        ...
        chapter: 7, character: "光光和东东", type: "尾声", mood: "温馨",
    }),
];
